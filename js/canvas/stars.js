function fn() {
  ...
  document.getElementById("canvasContainer").appendChild(canvas),
    ctx = canvas.getContext('2d'), w = canvas.width = window.innerWidth, h = canvas.height = window.innerHeight, hue = 217, stars = [], count = 0, maxStars = 1200;
  var canvas2 = document.createElement('canvas'),
    ctx2 = canvas2.getContext('2d');
  document.getElementById("canvasContainer").appendChild(canvas2),
    canvas2.width = 100;
  canvas2.height = 100;
