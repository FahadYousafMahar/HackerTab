...
// BEGIN jscolor code
    ...
    var jscolor = (function () { // BEGIN jscolor
        ...
        var jsc = {
            ...
            // Safely calls a function specified in picker's property
            triggerCallback: function (thisObj, prop) {
                const candidate = thisObj[prop];

                if (!candidate) return;

                if (typeof candidate === 'function') {
                    candidate.call(thisObj);
                } else {
                    console.warn(`Callback for "${prop}" is not a function and will be ignored.`, candidate);
                }
            },
